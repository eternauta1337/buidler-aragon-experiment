...
config_1.task('aragon:has_permission', 'Checks a permission in an Aragon app')
    ...
    const hasPermission = await aclInstance.hasPermission(account, appInstance.address, role);
